        ...
        <div class="row align-items-center">
          <div class="col-lg-12">
            <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
              <h1 class="mb-4 text-center" style="font-size: 100px;">
                <span class="text-danger">Master your own domain</span> <br>
              </h1>
              <h5 class="mb-4 mb-md-5 text-center">
                <i>
          ...
          <div class="d-flex justify-content-center align-items-center">
            <!-- Trigger Button -->
            <div class="input-button-group text-center">
              <input type="email" id="emailInput" class="form-control d-inline-block w-50 rounded-start-pill"
                ...
                <div class="modal-content border-0 shadow-lg rounded-4">
                  <div class="modal-header border-0 bg-light rounded-top-4 px-4 pt-4">
                    <div class="d-flex align-items-center">
                      <div
                        class="bg-danger text-white rounded-circle d-flex justify-content-center align-items-center me-3"
                        style="width: 40px; height: 40px;">
                        <i class="bi bi-stars fs-5"></i>
                      </div>
                      <h5 class="modal-title fw-bold" id="waitlistModalLabel">We’re thrilled
                        you’re interested!</h5>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body px-4 pb-4">
                    <p class="text-muted mb-4">Sign up with your email to secure your spot on the
                      waitlist. Let’s get to know you better.</p>
                    <form id="waitlist-form">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="email" class="form-control rounded-pill" id="modalEmail"
                          placeholder="you@example.com" readonly>
                      </div>
                      <button type="submit" id="submitBtn" class="btn btn-danger w-100 rounded-pill mt-3">Join
