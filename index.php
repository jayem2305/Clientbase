                    ...
                    <div class="card p-2 rounded-4" style="background-color: rgba(137, 16, 20, 0.07);">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <!-- Icon column -->
                          <div
                            class="col-lg-3 d-flex justify-content-center align-items-center px-5 order-1 order-lg-2">
                            <i class="bi bi-patch-check" style="font-size: 5rem; color:#891014;"></i>
                          </div>

                          <!-- Text column -->
                          <div class="col-lg-9 px-5 order-2 order-lg-1">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                ...
                <div class="form-floating">
                  <textarea class="form-control" id="inquiry" placeholder="Leave a comment here" id="floatingTextarea2"
